...
print("\nHere's what your maze looks like:")
print("S is the start point, E is the end point, hash is a wall, and dot is open space you can walk on.")
...
if find_path(maze, start_x, start_y, end_x, end_y, visited, path_board):
    print("A path was found! Star marks the path from start to end.\n")
    for row in path_board:
        print(" ".join(str(cell) for cell in row))
else:
    print("No valid path exists in this generated maze.")